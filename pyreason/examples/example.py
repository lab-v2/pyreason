...
def argparser():
    ...
    parser.add_argument("--graph_path", type=str, default='pyreason/examples/example_graph/honda_subgraph.graphml')
    parser.add_argument("--timesteps", type=int, default=2)
    parser.add_argument("--labels_yaml_path", type=str, default='pyreason/examples/example_yamls/labels.yaml')
    parser.add_argument("--rules_yaml_path", type=str, default='pyreason/examples/example_yamls/rules.yaml')
    parser.add_argument("--facts_yaml_path", type=str, default='pyreason/examples/example_yamls/facts.yaml')
