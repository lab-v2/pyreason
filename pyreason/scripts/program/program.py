...
class Program:
    ...
    def reason(self,
        ...
        interp = Interpretation(self._graph, self._tmax, self._ipl, self._reverse_graph, self._atom_trace,
                                self._save_graph_attributes_to_rule_trace, convergence_threshold,
                                convergence_bound_threshold)
