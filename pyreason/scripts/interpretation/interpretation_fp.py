...
class Interpretation:
	...
	def __init__(self, graph, ipl, annotation_functions, head_functions, reverse_graph, atom_trace, save_graph_attributes_to_rule_trace, persistent, inconsistency_check, store_interpretation_changes, update_mode, allow_ground_rules):
		...
		# Metadata parallel to rule_trace: (consistent: bool, triggered_by: str, name: str, inconsistency_msg: str)
		rule_trace_metadata_type = numba.types.Tuple((numba.types.boolean, numba.types.string, numba.types.string, numba.types.string))
		self.rule_trace_node_metadata = numba.typed.List.empty_list(rule_trace_metadata_type)
		self.rule_trace_edge_metadata = numba.typed.List.empty_list(rule_trace_metadata_type)
	...
	def reason(interpretations_node, interpretations_edge, predicate_map_node, predicate_map_edge, tmax, prev_reasoning_data, rules, nodes, edges, neighbors, reverse_neighbors, rules_to_be_applied_node, rules_to_be_applied_edge, edges_to_be_added_node_rule, edges_to_be_added_edge_rule, rules_to_be_applied_node_trace, rules_to_be_applied_edge_trace, facts_to_be_applied_node, facts_to_be_applied_edge, facts_to_be_applied_node_trace, facts_to_be_applied_edge_trace, ipl, rule_trace_node, rule_trace_edge, rule_trace_node_atoms, rule_trace_edge_atoms, reverse_graph, atom_trace, save_graph_attributes_to_rule_trace, persistent, inconsistency_check, store_interpretation_changes, update_mode, allow_ground_rules, max_facts_time, annotation_functions, head_functions, convergence_mode, convergence_delta, verbose, again, rule_trace_node_metadata, rule_trace_edge_metadata):
		...
		while fp_loop:
			...
			while timestep_loop:
					...
					if facts_to_be_applied_node[i][0] == t:
						...
						if l in interpretations_node[t][comp].world and interpretations_node[t][comp].world[l].is_static():
							...
							if (save_graph_attributes_to_rule_trace or not graph_attribute) and store_interpretation_changes:
								...
								_update_rule_trace_metadata(rule_trace_node_metadata, True, 'Fact', meta_name, '')
								for p1, p2 in ipl:
									if p1==l:
										...
										_update_rule_trace_metadata(rule_trace_node_metadata, True, 'IPL', f'IPL: {l.get_value()}', '')
									elif p2==l:
							...
							if check_consistent_node(interpretations_node[t], comp, (l, bnd)):
								...
								u, changes = _update_node(interpretations_node[t], predicate_map_node, comp, (l, bnd), ipl, rule_trace_node, fp_cnt, t, static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_node_trace, i, facts_to_be_applied_node_trace, rule_trace_node_atoms, store_interpretation_changes, mode=mode, rule_trace_metadata=rule_trace_node_metadata, override=override)
							...
							# Resolve inconsistency if necessary otherwise override bounds
								...
								if inconsistency_check:
									resolve_inconsistency_node(interpretations_node[t], comp, (l, bnd), ipl, t, fp_cnt, i, atom_trace, rule_trace_node, rule_trace_node_atoms, rules_to_be_applied_node_trace, facts_to_be_applied_node_trace, store_interpretation_changes, mode=mode, rule_trace_metadata=rule_trace_node_metadata)
								else:
									u, changes = _update_node(interpretations_node[t], predicate_map_node, comp, (l, bnd), ipl, rule_trace_node, fp_cnt, t, static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_node_trace, i, facts_to_be_applied_node_trace, rule_trace_node_atoms, store_interpretation_changes, mode=mode, rule_trace_metadata=rule_trace_node_metadata, override=True)
					...
					if facts_to_be_applied_edge[i][0] == t:
						...
						if l in interpretations_edge[t][comp].world and interpretations_edge[t][comp].world[l].is_static():
							...
							if (save_graph_attributes_to_rule_trace or not graph_attribute) and store_interpretation_changes:
								...
								_update_rule_trace_metadata(rule_trace_edge_metadata, True, 'Fact', meta_name, '')
								for p1, p2 in ipl:
									if p1 == l:
										...
										_update_rule_trace_metadata(rule_trace_edge_metadata, True, 'IPL', f'IPL: {l.get_value()}', '')
									elif p2 == l:
							...
							# Resolve inconsistency
								...
								mode = 'graph-attribute-fact' if graph_attribute else 'fact'
								if inconsistency_check:
									resolve_inconsistency_edge(interpretations_edge[t], comp, (l, bnd), ipl, t, fp_cnt, i, atom_trace, rule_trace_edge, rule_trace_edge_atoms, rules_to_be_applied_edge_trace, facts_to_be_applied_edge_trace, store_interpretation_changes, mode=mode, rule_trace_metadata=rule_trace_edge_metadata)
								else:
									u, changes = _update_edge(interpretations_edge[t], predicate_map_edge, comp, (l, bnd), ipl, rule_trace_edge, fp_cnt, t, static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_edge_trace, i, facts_to_be_applied_edge_trace, rule_trace_edge_atoms, store_interpretation_changes, mode=mode, rule_trace_metadata=rule_trace_edge_metadata, override=True)
				...
				for i in prange(len(rules)):
					...
					if t + delta_t <= tmax or tmax == -1 or again:
						applicable_node_rules, applicable_edge_rules = _ground_rule(rule, interpretations_node[t], interpretations_edge[t], predicate_map_node, predicate_map_edge, nodes, edges, neighbors, reverse_neighbors, atom_trace, allow_ground_rules, t, head_functions)
			...
			for idx, i in enumerate(rules_to_be_applied_node):
				...
				if check_consistent_node(interpretations_node[t], comp, (l, bnd)):
					override = True if update_mode == 'override' else False
					u, changes = _update_node(interpretations_node[t], predicate_map_node, comp, (l, bnd), ipl, rule_trace_node, fp_cnt, t, set_static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_node_trace, idx, facts_to_be_applied_node_trace, rule_trace_node_atoms, store_interpretation_changes, mode='rule', rule_trace_metadata=rule_trace_node_metadata, override=override)
				...
				# Resolve inconsistency
					...
					if inconsistency_check:
						resolve_inconsistency_node(interpretations_node[t], comp, (l, bnd), ipl, t, fp_cnt, idx, atom_trace, rule_trace_node, rule_trace_node_atoms, rules_to_be_applied_node_trace, facts_to_be_applied_node_trace, store_interpretation_changes, mode='rule', rule_trace_metadata=rule_trace_node_metadata)
					else:
						u, changes = _update_node(interpretations_node[t], predicate_map_node, comp, (l, bnd), ipl, rule_trace_node, fp_cnt, t, set_static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_node_trace, idx, facts_to_be_applied_node_trace, rule_trace_node_atoms, store_interpretation_changes, mode='rule', rule_trace_metadata=rule_trace_node_metadata, override=True)
				...
				if edge_l.value != '':
					for e in edges_added:
						...
						if check_consistent_edge(interpretations_edge[t], e, (edge_l, bnd)):
							override = True if update_mode == 'override' else False
							u, changes = _update_edge(interpretations_edge[t], predicate_map_edge, e, (edge_l, bnd), ipl, rule_trace_edge, fp_cnt, t, set_static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_edge_trace, idx, facts_to_be_applied_edge_trace, rule_trace_edge_atoms, store_interpretation_changes, mode='rule', rule_trace_metadata=rule_trace_edge_metadata, override=override)
						...
						# Resolve inconsistency
							...
							if inconsistency_check:
								resolve_inconsistency_edge(interpretations_edge[t], e, (edge_l, bnd), ipl, t, fp_cnt, idx, atom_trace, rule_trace_edge, rule_trace_edge_atoms, rules_to_be_applied_edge_trace, facts_to_be_applied_edge_trace, store_interpretation_changes, mode='rule', rule_trace_metadata=rule_trace_edge_metadata)
							else:
								u, changes = _update_edge(interpretations_edge[t], predicate_map_edge, e, (edge_l, bnd), ipl, rule_trace_edge, fp_cnt, t, set_static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_edge_trace, idx, facts_to_be_applied_edge_trace, rule_trace_edge_atoms, store_interpretation_changes, mode='rule', rule_trace_metadata=rule_trace_edge_metadata, override=True)
					...
					if check_consistent_edge(interpretations_edge[t], comp, (l, bnd)):
						override = True if update_mode == 'override' else False
						u, changes = _update_edge(interpretations_edge[t], predicate_map_edge, comp, (l, bnd), ipl, rule_trace_edge, fp_cnt, t, set_static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_edge_trace, idx, facts_to_be_applied_edge_trace, rule_trace_edge_atoms, store_interpretation_changes, mode='rule', rule_trace_metadata=rule_trace_edge_metadata, override=override)
					...
					# Resolve inconsistency
						...
						if inconsistency_check:
							resolve_inconsistency_edge(interpretations_edge[t], comp, (l, bnd), ipl, t, fp_cnt, idx, atom_trace, rule_trace_edge, rule_trace_edge_atoms, rules_to_be_applied_edge_trace, facts_to_be_applied_edge_trace, store_interpretation_changes, mode='rule', rule_trace_metadata=rule_trace_edge_metadata)
						else:
							u, changes = _update_edge(interpretations_edge[t], predicate_map_edge, comp, (l, bnd), ipl, rule_trace_edge, fp_cnt, t, set_static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_edge_trace, idx, facts_to_be_applied_edge_trace, rule_trace_edge_atoms, store_interpretation_changes, mode='rule', rule_trace_metadata=rule_trace_edge_metadata, override=True)
...
@numba.njit(cache=True)
def _ground_rule(rule, interpretations_node, interpretations_edge, predicate_map_node, predicate_map_edge, nodes, edges, neighbors, reverse_neighbors, atom_trace, allow_ground_rules, t, head_functions):
	# Extract rule params
...
@numba.njit(cache=True)
def _update_node(interpretations, predicate_map, comp, na, ipl, rule_trace, fp_cnt, t_cnt, static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_trace, idx, facts_to_be_applied_trace, rule_trace_atoms, store_interpretation_changes, mode, rule_trace_metadata, override=False):
	updated = False
	...
	if world.world[l]!=prev_bnd:
		...
		if (save_graph_attributes_to_rule_trace or not mode=='graph-attribute-fact') and store_interpretation_changes:
			...
			# Determine triggered_by and name for metadata
			...
			if atom_trace:
				...
				if mode=='fact' or mode=='graph-attribute-fact':
					...
					_update_rule_trace(rule_trace_atoms, qn, qe, prev_bnd, meta_name)
				elif mode=='rule':
					qn, qe, meta_name = rules_to_be_applied_trace[idx]
					_update_rule_trace(rule_trace_atoms, qn, qe, prev_bnd, meta_name)
			_update_rule_trace_metadata(rule_trace_metadata, True, triggered_by, meta_name, '')
		...
		for p1, p2 in ipl:
			if p1 == l:
				...
				if store_interpretation_changes:
					...
					_update_rule_trace_metadata(rule_trace_metadata, True, 'IPL', f'IPL: {l.get_value()}', '')
			if p2 == l:
...
@numba.njit(cache=True)
def _update_edge(interpretations, predicate_map, comp, na, ipl, rule_trace, fp_cnt, t_cnt, static, convergence_mode, atom_trace, save_graph_attributes_to_rule_trace, rules_to_be_applied_trace, idx, facts_to_be_applied_trace, rule_trace_atoms, store_interpretation_changes, mode, rule_trace_metadata, override=False):
	updated = False
	world = interpretations[comp]
	l, bnd = na
	updated_bnds = numba.typed.List.empty_list(interval.interval_type)
...
@numba.njit(cache=True)
def _update_rule_trace_metadata(rule_trace_metadata, consistent, triggered_by, name, inconsistency_msg):
	rule_trace_metadata.append((consistent, triggered_by, name, inconsistency_msg))
...
@numba.njit(cache=True)
def resolve_inconsistency_node(interpretations, comp, na, ipl, t_cnt, fp_cnt, idx, atom_trace, rule_trace, rule_trace_atoms, rules_to_be_applied_trace, facts_to_be_applied_trace, store_interpretation_changes, mode, rule_trace_metadata):
	world = interpretations[comp]
	# Build descriptive message before any trace calls
	msg = ''
	if atom_trace:
		comp_label_value = ''
		for _p1, _p2 in ipl:
			if _p1 == na[0]:
				comp_label_value = _p2.value
				break
			if _p2 == na[0]:
				comp_label_value = _p1.value
				break
		if comp_label_value != '':
			msg = f'Inconsistency occurred. Grounding {na[0].value}({comp}) conflicts with grounding {comp_label_value}({comp}). Setting bounds to [0,1] and static=True for this timestep.'
		else:
			msg = f'Inconsistency occurred. Conflicting bounds for {na[0].value}({comp}). Update from [{float_to_str(world.world[na[0]].lower)}, {float_to_str(world.world[na[0]].upper)}] to [{float_to_str(na[1].lower)}, {float_to_str(na[1].upper)}] is not allowed. Setting bounds to [0,1] and static=True for this timestep.'

	# Determine triggered_by and look up actual name/clauses from the triggering fact/rule
	if mode == 'fact' or mode == 'graph-attribute-fact':
		triggered_by = 'Fact'
	else:
		triggered_by = 'Rule'
	...
	if store_interpretation_changes:
		...
		_update_rule_trace_metadata(rule_trace_metadata, False, triggered_by, actual_name, msg)
	...
	for p1, p2 in ipl:
		if p1==na[0]:
			...
			if store_interpretation_changes:
				...
				_update_rule_trace_metadata(rule_trace_metadata, False, 'IPL', actual_name, msg)
...
@numba.njit(cache=True)
def resolve_inconsistency_edge(interpretations, comp, na, ipl, t_cnt, fp_cnt, idx, atom_trace, rule_trace, rule_trace_atoms, rules_to_be_applied_trace, facts_to_be_applied_trace, store_interpretation_changes, mode, rule_trace_metadata):
	...
	if atom_trace:
		...
		for _p1, _p2 in ipl:
			...
			if _p2 == na[0]:
				...
				break
		if comp_label_value != '':
			msg = f'Inconsistency occurred. Grounding {na[0].value}({comp[0]},{comp[1]}) conflicts with grounding {comp_label_value}({comp[0]},{comp[1]}). Setting bounds to [0,1] and static=True for this timestep.'
		else:
			msg = f'Inconsistency occurred. Conflicting bounds for {na[0].value}({comp[0]},{comp[1]}). Update from [{float_to_str(w.world[na[0]].lower)}, {float_to_str(w.world[na[0]].upper)}] to [{float_to_str(na[1].lower)}, {float_to_str(na[1].upper)}] is not allowed. Setting bounds to [0,1] and static=True for this timestep.'
