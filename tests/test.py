...
interface_options = pr.ModelInterfaceOptions(
    threshold=0.4,       # Only process probabilities above 0.5
...
# Run the reasoning engine for 3 timesteps to allow the investigation flag to propagate through the network.
