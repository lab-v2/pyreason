...
class Output:
    ...
    def write(self, interpretation):
        ...
        with open('mancalog/output/nodes.pkl', 'wb') as file:
            pickle.dump(dfs_nodes, file)
        with open('mancalog/output/edges.pkl', 'wb') as file:
    ...
    def read(self, component_type):
        if component_type == 'nodes':
            with open('mancalog/output/nodes.pkl', 'rb') as file:
                return pickle.load(file)
        elif component_type == 'edges':
            with open('mancalog/output/edges.pkl', 'rb') as file:
                return pickle.load(file)
